...
-- 导出 myblog 的数据库结构
CREATE DATABASE IF NOT EXISTS `myblog` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `myblog`;

-- 导出  表 myblog.archives 结构
...
-- 正在导出表  myblog.archives 的数据：~3 rows (大约)
/*!40000 ALTER TABLE `archives` DISABLE KEYS */;
REPLACE INTO `archives` (`id`, `archiveName`) VALUES
	(1, '2018年07月'),
	(2, '2018年08月'),
	(4, '2021年01月');
/*!40000 ALTER TABLE `archives` ENABLE KEYS */;

-- 导出  表 myblog.article 结构
...
-- 正在导出表  myblog.article_likes_record 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `article_likes_record` DISABLE KEYS */;
REPLACE INTO `article_likes_record` (`id`, `articleId`, `likerId`, `likeDate`, `isRead`) VALUES
	(1, 1532884460, 1, '2018-07-31 20:00', 0),
	(2, 1533196734, 1, '2018-08-02 21:24', 0);
/*!40000 ALTER TABLE `article_likes_record` ENABLE KEYS */;

-- 导出  表 myblog.categories 结构
...
-- 正在导出表  myblog.categories 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
REPLACE INTO `categories` (`id`, `categoryName`) VALUES
	(1, '我的故事'),
	(2, 'SpringBoot');
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;

-- 导出  表 myblog.comment_likes_record 结构
CREATE TABLE IF NOT EXISTS `comment_likes_record` (
  `id` int NOT NULL AUTO_INCREMENT,
  `articleId` bigint NOT NULL,
  `pId` int NOT NULL,
  `likerId` int NOT NULL,
...
-- 正在导出表  myblog.comment_likes_record 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `comment_likes_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `comment_likes_record` ENABLE KEYS */;

-- 导出  表 myblog.comment_record 结构
...
-- 正在导出表  myblog.comment_record 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `comment_record` DISABLE KEYS */;
REPLACE INTO `comment_record` (`id`, `pId`, `articleId`, `answererId`, `respondentId`, `commentDate`, `likes`, `commentContent`, `isRead`) VALUES
	(2, 0, 1533196734, 1, 1, '2018-08-03 00:13', 1, '测试评论功能，嘻嘻嘻', 0),
	(3, 2, 1533196734, 1, 1, '2018-08-03 00:15', 0, '一切正常，哈哈哈', 0);
/*!40000 ALTER TABLE `comment_record` ENABLE KEYS */;

-- 导出  表 myblog.daily_speech 结构
...
-- 正在导出表  myblog.feedback 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback` ENABLE KEYS */;

-- 导出  表 myblog.friendlink 结构
...
-- 正在导出表  myblog.friendlink 的数据：~10 rows (大约)
/*!40000 ALTER TABLE `friendlink` DISABLE KEYS */;
REPLACE INTO `friendlink` (`id`, `blogger`, `url`) VALUES
	(1, 'naget的小屋', 'https://naget.github.io'),
	(2, 'Li Pan\'s 博客', 'http://www.lipan.xyz'),
	(3, '陈晓雷个人博客', 'http://www.csxll.top'),
	(4, 'SAn Blog', 'https://sanii.cn'),
	(5, '会打篮球的程序猿', 'http://www.liuzhaopo.top'),
	(6, 'Mr_曾中杰', 'https://www.zengzhongjie.com'),
	(7, '去当CTO', 'https://www.qdcto.com'),
	(8, 'Face2Object', 'https://www.bossding.com.cn'),
	(9, '小海博客', 'https://www.celess.cn'),
	(10, '枫之羽', 'http://fzhiy.com');
/*!40000 ALTER TABLE `friendlink` ENABLE KEYS */;

-- 导出  表 myblog.leave_message_likes_record 结构
CREATE TABLE IF NOT EXISTS `leave_message_likes_record` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  myblog.leave_message_likes_record 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `leave_message_likes_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `leave_message_likes_record` ENABLE KEYS */;

-- 导出  表 myblog.leave_message_record 结构
CREATE TABLE IF NOT EXISTS `leave_message_record` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pageName` varchar(255) NOT NULL,
  `pId` int NOT NULL,
  `answererId` int NOT NULL,
...
-- 正在导出表  myblog.leave_message_record 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `leave_message_record` DISABLE KEYS */;
REPLACE INTO `leave_message_record` (`id`, `pageName`, `pId`, `answererId`, `respondentId`, `leaveMessageDate`, `likes`, `leaveMessageContent`, `isRead`) VALUES
	(14, 'categories', 0, 1, 1, '2018-09-19 13:53', 0, '分类留言测试', 0),
	(15, 'archives', 0, 1, 1, '2018-09-19 13:53', 0, '归档留言', 0),
	(16, 'tags', 0, 1, 1, '2018-09-19 13:53', 0, '标签留言', 0),
	(17, 'update', 0, 1, 1, '2018-09-19 13:53', 0, '更新留言', 0),
	(18, 'friendlylink', 0, 1, 1, '2018-09-19 13:54', 0, '需要添加友链的朋友可在www.zhyocean.cn/friendlylink下方留言（网站名称+网址），随后验证后会在本人博客中添加友链链接', 0);
/*!40000 ALTER TABLE `leave_message_record` ENABLE KEYS */;

-- 导出  表 myblog.privateword 结构
CREATE TABLE IF NOT EXISTS `privateword` (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  myblog.privateword 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `privateword` DISABLE KEYS */;
REPLACE INTO `privateword` (`id`, `privateWord`, `publisherId`, `replierId`, `replyContent`, `publisherDate`) VALUES
	(8, '悄悄话测试', '1', '0', NULL, '2018-09-19 14:13:32');
/*!40000 ALTER TABLE `privateword` ENABLE KEYS */;

-- 导出  表 myblog.reward 结构
...
-- 正在导出表  myblog.reward 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `reward` DISABLE KEYS */;
REPLACE INTO `reward` (`id`, `fundRaiser`, `fundRaisingSources`, `fundraisingPlace`, `rewardMoney`, `remarks`, `rewardDate`, `rewardUrl`) VALUES
	(1, '海**依', '公众号赞赏', '《搜狐焦点·拯救先心儿》', 20, '无', '2019-07-04 00:00:00', 'https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/public/rewardRecord/2019-07-15/1563121018.jpeg');
...
-- 正在导出表  myblog.role 的数据：~3 rows (大约)
...
-- 正在导出表  myblog.tags 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `tags` DISABLE KEYS */;
REPLACE INTO `tags` (`id`, `tagName`, `tagSize`) VALUES
	(1, '随笔感悟', 15),
	(4, 'SpringBoot', 17),
	(5, '个人博客', 18),
	(18, '原创', 20),
...
-- 正在导出表  myblog.user 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
REPLACE INTO `user` (`id`, `phone`, `username`, `password`, `gender`, `trueName`, `birthday`, `email`, `personalBrief`, `avatarImgUrl`, `recentlyLanded`) VALUES
	(1, '15182681047', '夏兮兮', 'a3caed36f0fe5a01e5f144db8927235e', 'female', '夏', '1997-08-23', 'ddawnxia@163.com', '', 'https://zhy-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/张海洋/1575283189.png', '2021-01-26 15:27:45');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- 导出  表 myblog.user_role 结构
CREATE TABLE IF NOT EXISTS `user_role` (
  `User_id` int NOT NULL,
  `Role_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  myblog.user_role 的数据：~3 rows (大约)
...
-- 正在导出表  myblog.visitor 的数据：~5 rows (大约)
/*!40000 ALTER TABLE `visitor` DISABLE KEYS */;
REPLACE INTO `visitor` (`id`, `visitorNum`, `pageName`) VALUES
	(1, 3228, 'totalVisitor'),
	(2, 1032, 'visitorVolume'),
	(3, 42, 'article/1532884460'),
	(5, 57, 'article/1533196734'),
	(22, 0, 'article/1611646400');
